...
fun main() = runBlocking { // block the main thread
    ...
    */
    ...
    joinAll(
         ...
         */
        async { coroutineWithThreadInfo(1, 500) }, // this will start the coroutines at the same time
        async { coroutineWithThreadInfo(2, 300) }  // this will start the coroutines at the same time
    )
 ...
 */
suspend fun coroutineWithThreadInfo(number: Int, delayInMillis: Long) {
